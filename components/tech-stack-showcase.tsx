      ...
      {categories.map((cat, gi) => {
        ...
        return (
          <motion.div
            ...
            whileHover={{ y: -3 }}
            className="group flex h-full w-full min-w-0 flex-col rounded-2xl border border-slate-200/90 bg-gradient-to-b from-white to-slate-50/80 p-3.5 text-center shadow-sm ring-1 ring-slate-100/70 backdrop-blur-sm transition-shadow hover:shadow-md sm:p-4"
          >
